...
export const CATEGORY_META: Record<string, CategoryMeta> = {
  ...
  "디자인 / 공예":{ minCount: 1, unit: "회", hint: "매체발표 또는 전시 합산 5회 이상" },
  "일반미술":     { minCount: 1, unit: "회", hint: "매체발표 또는 전시 합산 5회 이상" },
  "전통미술":     { minCount: 1, unit: "회", hint: "매체발표 또는 전시 합산 5회 이상" },
  "사진":         { minCount: 1, unit: "회", hint: "매체발표 또는 전시 합산 5회 이상" },
  "건축":         { minCount: 1, unit: "회", hint: "매체발표 또는 전시 합산 5회 이상" },
  "만화":         { minCount: 1, unit: "편", hint: "작품 발표 5편 이상 (연재의 경우 6개월 이상 1편)" },
  "방송":         { minCount: 1, unit: "편", hint: "드라마·예능·교양 프로그램 출연 3편 이상" },
  "공연":         { minCount: 1, unit: "편", hint: "공연 출연 3편 이상" },
  "연극":         { minCount: 1, unit: "편", hint: "연극 공연 출연 3편 이상" },
  "무용":         { minCount: 1, unit: "편", hint: "무용 공연 출연 3편 이상" },
  "영화":         { minCount: 1, unit: "편", hint: "상영영화 출연 3편 이상" },
  "국악":         { minCount: 1, unit: "편", hint: "공연 출연 또는 악곡 발표 3편 이상" },
  "대중음악":     { minCount: 1, unit: "편", hint: "공연 출연 또는 악곡 발표 3편 이상" },
  "일반음악":     { minCount: 1, unit: "편", hint: "공연 출연 또는 악곡 발표 3편 이상" },
};
